...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->lblTitulo->Text = L"BARBER�A EL GATO PEL�N";
			// 
			// cmbBarberos
			// 
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(950, 92);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(152, 23);
			this->button1->TabIndex = 7;
			this->button1->Text = L"Cambio de barberos";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &Barberia::button1_Click);
			// 
			// Barberia
			// 
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (primeraVezTabla != 0) {
			for (int i = gridViewBarberos->Rows->Count - 1; i >= 0; i--) {
				DataGridViewRow^ row = gridViewBarberos->Rows[i];
				if (!row->IsNewRow) {
					gridViewBarberos->Rows->Remove(row);
				}
			}
			gridViewBarberos->Update();
		}
